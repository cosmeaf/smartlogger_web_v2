    ...
    <div className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <div className="absolute -top-1 -right-1 flex items-center justify-center">
            <span className="relative bg-white dark:bg-gray-800 rounded-full p-0.5 shadow-sm">
              <span className={`text-white text-xs font-semibold rounded-full min-w-[18px] h-[18px] flex items-center justify-center shadow-md transform transition-transform hover:scale-110 ${
                isDarkMode 
      ...
      {isOpen && (
        <>
          ...
          <div className={`absolute ${
          ...
          } border rounded-xl shadow-2xl ${isMobile ? 'max-h-[80vh]' : 'max-h-[85vh]'} overflow-hidden backdrop-blur-sm`}>
            
            {/* Header */}
            <div className={`${isMobile ? 'p-2.5' : 'p-3'} border-b ${
              isDarkMode 
                ? 'border-gray-700' 
              ...
              <div className="flex items-center justify-between">
                <div className={`flex items-center ${isMobile ? 'space-x-2' : 'space-x-3'}`}>
                  <div className={`${isMobile ? 'p-1' : 'p-1.5'} rounded-lg ${isDarkMode ? 'bg-blue-900/30' : 'bg-blue-700/30'}`}>
                ...
                <button
                  ...
                  className={`${isMobile ? 'p-1' : 'p-1.5'} rounded-lg transition-colors ${
                    isDarkMode 
                      ...
                      : 'hover:bg-blue-700 text-blue-300 hover:text-blue-200'
                  }`}
                >
              ...
              {maintenanceTypes.length > 2 && (
                <div className={`${isMobile ? 'mt-2' : 'mt-3'}`}>
                  <label className={`${isMobile ? 'text-xs' : 'text-xs'} font-medium block ${isMobile ? 'mb-1.5' : 'mb-2'} ${
                  ...
                  <select
                    ...
                    className={`w-full ${isMobile ? 'text-xs px-2.5 py-1.5' : 'text-xs px-3 py-2'} rounded-lg border transition-colors ${
                      isDarkMode 
                        ? 'bg-gray-700 border-gray-600 text-white focus:border-blue-400' 
                        : 'bg-blue-800 border-blue-600 text-white focus:border-blue-400'
                  ...
                  <div className={`flex items-center ${isMobile ? 'space-x-2' : 'space-x-3'}`}>
                    ...
                    {selectedFilter !== 'todos' && (
                      <div className={`px-2 py-1 rounded-full text-xs ${
                        isDarkMode ? 'bg-blue-900/30 text-blue-400' : 'bg-blue-800/50 text-blue-100'
                      }`}>
            ...
            {/* Footer */}
            {lastUpdate && (
              <div className={`${isMobile ? 'px-3 py-2' : 'px-5 py-3'} border-t text-center ${
